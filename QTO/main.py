...
parser.add_argument('--plm_name', default='./kbc/src/PLM/bert-base-cased', type=str, help='path for loading PLM model')
...
def parse_args(args=None):
    ...
    parser.add_argument('--kbc_path', type=str, default='kbc/FB15K-237/best_valid.model', help="kbc model path")
    ...
    parser.add_argument('--fraction', type=int, default=10, help='fraction the entity to save gpu memory usage')
    parser.add_argument('--thrshd', type=float, default=0.0002, help='thrshd for neural adjacency matrix')
    parser.add_argument('--neg_scale', type=int, default=3, help='scaling neural adjacency matrix for negation')
...
def main(args):
    if args.dataset == 'FB15k-237':
        ...
        args.plm_name = './kbc/src/PLM/bert-base-cased'
        args.extractor_num_attention_heads = 8
        args.max_seq_len = 512
        args.extractor_attention_probs_dropout_prob = 0.1
        args.device = 'cuda'
        opt = vars(args)
        args.data_path = 'data/FB15k-237-betae'
        args.kbc_path = 'kbc/FB15k-237/best_valid.model'
        args.fraction = 10
        args.thrshd = 0.0005
        args.neg_scale = 3
        ...
        args.kbc_path = 'kbc/NELL995/best_valid.model'
        args.fraction = 10
        args.thrshd = 0.0003
        args.neg_scale = 6
        ...
        args.device = 'cuda'
        opt = vars(args)
        args.data_path = 'data/FB15k-betae'  # FB15k-237   NELL
        args.kbc_path = 'kbc/FB15K/best_valid.model'  # FB15K-237 NELL995
        args.fraction = 10
        args.thrshd = 0.01
        args.neg_scale = 6
    ...
    # # adj_list: [[(h, t), (h, t), ..., (h, t)], [(h, t), (h, t), ..., (h, t)], ... [(h, t), (h, t), ..., (h, t)]], len is nrelation
    # # edges_y: list of all triples in train+valid+test
    # # edges_p: list of all triples in valid+test
    ...
    model = KGReasoning(args, device, adj_list, query_name_dict, name_answer_dict, opt)
