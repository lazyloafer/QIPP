...
class MultiheadAttention(nn.Module):
    ...
    def forward(
        ...
        # attention_probs_np = attention_probs.cpu().numpy()
        # np.save('cone_attention_probs_np.npy', attention_probs_np)
...
class KnowExtractor(nn.Module):
    def __init__(self, args=None):
        ...
        if args.geo == 'beta':
            ...
            self.hidden_dim = self.args.hidden_dim
        self.plm_config = AutoConfig.from_pretrained(self.args.plm_name)
